 ...
 * General assistant focus (research, analysis, writing, coding)
 */
...
export class Agent {
  ...
  getSystemPrompt() {
    return `You are openClaude, an autonomous general assistant.
...
Available tools: file operations, shell commands, git, browser automation, research, analysis.
Focus on being helpful: research, writing, analysis, coding, problem-solving.`;
  }
