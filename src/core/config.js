...
const DEFAULTS = {
  ...
  port: Number(process.env.OPENCLAUDE_PORT || 18883),
  host: process.env.OPENCLAUDE_HOST || '127.0.0.1',

  autoApprove: true,
  autonomyMode: process.env.OPENCLAUDE_AUTONOMY_MODE || 'autonomy-first',
  maxIterations: 50,
  maxToolUses: 12,
  maxToolFailures: 3,
  maxContextTokens: 262144,
  compactionThreshold: 0.8,
  workspaceRoot: process.env.OPENCLAUDE_WORKSPACE || getRepoRoot(),
};
